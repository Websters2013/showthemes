...
<p class="dashboard-welcome">
    <?php
    echo sprintf(esc_attr__('Here you can view your recent orders, downloads, API keys, manage your billing addresses and %1$sedit your password and account details%2$s.', 'woocommerce'), '<a href="' . esc_url(wc_get_endpoint_url('edit-account')) . '">', '</a>');
    ?>
</p>
