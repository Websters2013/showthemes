...
if (!wc_ship_to_billing_address_only() && get_option('woocommerce_calc_shipping') !== 'no') {
    $page_title = apply_filters('woocommerce_my_account_my_address_title', __('Addresses', 'woocommerce'));
...
?>
<!-- checkout__address -->
<div class="checkout__info checkout__address">
    <h4 class="checkout__subtitle"><?php echo $page_title; ?></h4>
...
<?php foreach ($get_addresses as $name => $title) : ?>
    ...
    <div class="checkout__info checkout__address-bill">
        <h4 class="checkout__subtitle"><?php echo $title; ?></h4>
        <span><a href="<?php echo wc_get_endpoint_url('edit-address', $name); ?>"><?php _e('Edit', 'woocommerce'); ?></a></span>
        <?php
